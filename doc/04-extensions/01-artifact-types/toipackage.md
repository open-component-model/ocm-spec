...
steps based on content described by the Open Component Model (see the [TOI documentation](https://github.com/open-component-model/ocm/blob/main/docs/reference/ocm_toi-bootstrapping.md).)
