...
- [Build a Component Version](#build-a-component-version)

## Prerequisites

To follow the steps described in this section, you will need the following.

- The OCM Command Line Interface (CLI) to interact with component versions and registries. You can download it from the [releases](https://github.com/open-component-model/ocm/releases) or with the following command:
  ```shell
