...
* 4.2 [Access Method Types](doc/01-access-types/README.md)
  ...
  * 4.2.4 [helm](hdoc/01-access-types/helm.md)               
...
* 4.4 [Normalization Algorithms](doc/04-algorithms/README.md#normalization-algorithms)
  * 4.2.1 [jsonNormalisationV1](doc/04-algorithms/README.md#jsonnormalisationv1)
  * 4.2.2 [jsonNormalisationV1](doc/04-algorithms/README.md#jsonnormalisationv2)
* 4.5 [Digest Algorithms](doc/04-algorithms/README.md#digest-algorithms)
* 4.6 [Digesting Content](doc/04-algorithms/README.md#digesting-content)
* 4.7 [Signature Algorithms](doc/04-algorithms/README.md#signature-algorithms)
  * 4.7.1 [RSA](doc/04-algorithms/README.md#rsa)
