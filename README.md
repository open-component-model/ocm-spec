...
* 4.1 [Artifact Types](doc/extensions/01-artifact-types/README.md)
  * 4.1.1 [blob](doc/extensions/01-artifact-types/blob.md)                               
  * 4.1.2 [directoryTree, fileSystem](doc/extensions/01-artifact-types/file-system.md) 
  * 4.1.3 [gitOpsTemplate](doc/extensions/01-artifact-types/gitops.md)                   
  * 4.1.4 [helmChart](doc/extensions/01-artifact-types/helmchart.md)                     
  * 4.1.5 [npmPackage](doc/extensions/01-artifact-types/npm.md)                          
  * 4.1.6 [ociArtifact](doc/extensions/01-artifact-types/oci-artifact.md)                
  * 4.1.7 [ociImage](doc/extensions/01-artifact-types/oci-image.md)                     
  * 4.1.8 [executable](doc/extensions/01-artifact-types/executable.md)                   
  * 4.1.9 [sbom](doc/extensions/01-artifact-types/sbom.md)
* 4.2 [Access Method Types](doc/extensions/01-access-types/README.md)
  * 4.2.1 [localBlob](doc/extensions/01-access-types/localblob.md)     
  * 4.2.2 [ociArtifact](doc/extensions/01-access-types/ociartifact.md) 
  * 4.2.3 [ociBlob](doc/extensions/01-access-types/ociblob.md)         
  * 4.2.4 [helm](hdoc/extensions/01-access-types/helm.md)               
  * 4.2.5 [gitHub](doc/extensions/01-access-types/github.md)           
  * 4.2.6 [s3](doc/extensions/01-access-types/s3.md)                   
  * 4.2.7 [npm](doc/extensions/01-access-types/npm.md)     
* 4.3 [Storage Backend Mappings](doc/extensions/03-storage-backends/README.md)
  * 4.3.1 [OCIRegistry](doc/extensions/03-storage-backendsoci.md)                                  
  * 4.3.2 [FileSystem (CTF)](doc/extensions/03-storage-backendsctf.md)                             
  * 4.3.3 [FileSystem (Component Archive)](doc/extensions/03-storage-backendscomponent-archive.md) 
  * 4.3.4 [AWS S3](doc/extensions/03-storage-backendss3.md)       
* 4.4 [Normalization Algorithms](doc/extensions/04-algorithms/README.md#normalization-algorithms)
  * 4.2.1 [jsonNormalisationV1](doc/extensions/04-algorithms/README.md#jsonnormalisationv1)
  * 4.2.2 [jsonNormalisationV1](doc/extensions/04-algorithms/README.md#jsonnormalisationv2)
* 4.5 [Digest Algorithms](doc/extensions/04-algorithms/README.md#digest-algorithms)
* 4.6 [Digesting Content](doc/extensions/04-algorithms/README.md#digesting-content)
* 4.7 [Signature Algorithms](doc/extensions/04-algorithms/README.md#signature-algorithms)
  * 4.7.1 [RSA](doc/extensions/04-algorithms/README.md#rsa)
