...
* 1. [Model](doc/01-model/README.md)
  ...
  * 1.2. [Model Elements](doc/01-model/02-elements-toplevel.md)
    * 1.2.1 [Components and Component Versions](doc/01-model/02-elements-toplevel.md#component-identity)
  ...
  * 1.3. [Model Elements - Fundamentals](doc/01-model/03-elements-sub.md)
    * 1.3.1 [Identifiers](doc/01-model/03-elements-sub.md#element-identity)
    * 1.3.2 [Access Specification](doc/01-model/03-elements-sub.md#access-specification)
    * 1.3.3 [Access Types](doc/01-model/03-elements-sub.md#access-specification)
...
* 1. [Processing](doc/02-processing/README.md)
  ...
  * 2.3 [Normalization](doc/02-processing/03-signing-process.md#signing-process-and-normalization)
    * 2.3.1 [Artifact Digest](doc/02-processing/03-signing-process.md#determining-the-artifact-digests)
  ...
  * 2.4 [Example](doc/02-processing/04-signing-examples.md#examples-for-signing-of-component-versions)
  ...
  * 2.5 [Component Descriptor Normalization](doc/02-processing/05-component-descriptor-normalization.md#component-descriptor-normalization)
    * 2.5.1 [Signing-relevant information in Component Descriptors](doc/02-processing/05-component-descriptor-normalization.md#signing-relevant-information-in-component-descriptors)
...
* 1. [Persistence](doc/03-persistence/README.md)
...
* 1. [Guidelines](doc/05-guidelines/README.md)
...
Check out the main project [web page](https://ocm.software) to find out more about OCM. It is your central entry point to all kinds of ocm related [docs and guides](https://ocm.software/docs/getting-started) and all project-related [github repositories](https://github.com/open-component-model). It also offers a [Getting Started](https://ocm.software/docs/getting-started) to quickly make your hands dirty with ocm, its toolset and concepts :-)
